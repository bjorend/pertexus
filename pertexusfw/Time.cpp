...
/*
 * Bjoren Davis, June 7, 2022.
 * I copied this from c:\Program Files (x86)\Arduino\hardware\teensy\avr\cores\teensy4\Time.cpp,
 *  part of Teensyduino 1.56.
 * It had a small bug in makeTime() where it would create an incorrect value
 *  for dates after February 28 if one of {year, year + 70} was
 *  a leap year and the other was not.
 */
...
// previous version used full four digit year (or digits since 2000),i.e. 2009 was 2009 or 9
  ...
  for (i = 0; i < tm.mon; i++) {
    if ( (i == 1) && LEAP_YEAR(tm.year - 70)) { /* bkd 7-June-2022 */
